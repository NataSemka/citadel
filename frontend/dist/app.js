...
var _NataSemka$citadel$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _NataSemka$citadel$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _NataSemka$citadel$Main$view = function (model) {
	return A2(
...
var _NataSemka$citadel$Main$init = {ctor: '_Tuple2', _0: 'Hello', _1: _elm_lang$core$Platform_Cmd$none};
var _NataSemka$citadel$Main$main = _elm_lang$html$Html$program(
	{init: _NataSemka$citadel$Main$init, view: _NataSemka$citadel$Main$view, update: _NataSemka$citadel$Main$update, subscriptions: _NataSemka$citadel$Main$subscriptions})();
var _NataSemka$citadel$Main$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _NataSemka$citadel$Main$main !== 'undefined') {
    _NataSemka$citadel$Main$main(Elm['Main'], 'Main', undefined);
}
